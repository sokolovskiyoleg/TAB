...
public class BukkitPlatform implements BackendPlatform {
    ...
    private ImplementationProvider findImplementationProvider() {
        ...
        if (paperTps) { // This needs a better check
            ...
            if (paperModule != null) {
                try {
                    ...
                    throw new IllegalStateException("Failed to initialize implementation for Paper " + paperModule + ".", e);
                }
            } else {
        ...
        try {
            ...
            throw new IllegalStateException("Failed to initialize implementation for Spigot " + version + ".", e);
        }
    }
